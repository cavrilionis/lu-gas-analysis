...
download_meteolux_file <- function(dataset) {
...
dataset_name <- "inspire-annex-iii-meteorological-geographical-features-pointtimeseriesobservation-monthly-weather-measurements-at-luxembourg-findel-airport-1/"

if (file.exists("./../data/mf.pointtimeseriesobservation-monthly-findelairport.gml")) {
  cli_alert_info("MeteoLux data are already downloaded")
} else {
  download_meteolux_file(dataset_name)
}
